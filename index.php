    ...
    <div class="p-4 xl:ml-80">
            ...
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between p-4 xl:hidden">
              ...
              <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                <ul class="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                  <li>
                    <a href="index.php" class="block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 dark:text-white md:hidden lg:hidden xl:hidden md:dark:text-blue-500" aria-current="page">Dashboard</a>
                  </li>
                  <li>
      ...
      <div class="mt-12">
        <div class="mb-12 grid gap-y-10 gap-x-6 md:grid-cols-2 xl:grid-cols-4">
          ...
          <div class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
            ...
            <div class="p-4 text-right">
              <p class="block antialiased font-sans text-sm leading-normal font-normal text-blue-gray-600">Data Absen</p>
              <h4 class="block antialiased tracking-normal font-sans text-2xl font-semibold leading-snug text-blue-gray-900">
                <?= $totalAbsensi[0]['total'] ?>
          ...
          <div class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
            ...
            <div class="p-4 text-right">
              <p class="block antialiased font-sans text-sm leading-normal font-normal text-blue-gray-600">Belum Absen</p>
              <h4 class="block antialiased tracking-normal font-sans text-2xl font-semibold leading-snug text-blue-gray-900">
                <?= $totalAbsensi[0]['total'] ?>
              </h4>
            </div>
            <div class="border-t border-blue-gray-50 p-4">
              <p class="block antialiased font-sans text-base leading-relaxed font-normal text-blue-gray-600">
                <strong class="text-red-500">Maksimal 2x</strong>&nbsp; / BULAN
              </p>
            </div>
          </div>
          ...
          <div class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
            ...
            <div class="p-4 text-right">
              <p class="block antialiased font-sans text-sm leading-normal font-normal text-blue-gray-600">Total Karyawan</p>
              <h4 class="block antialiased tracking-normal font-sans text-2xl font-semibold leading-snug text-blue-gray-900">10</h4>
            </div>
            <div class="border-t border-blue-gray-50 p-4">
              <p class="block antialiased font-sans text-base leading-relaxed font-normal text-blue-gray-600">
                <strong class="text-green-500">Data</strong>&nbsp;/ TAHUN 2024
              </p>
            </div>
          </div>
          ...
          <div class="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
            ...
            <div class="p-4 text-right">
              <p class="block antialiased font-sans text-sm leading-normal font-normal text-blue-gray-600">Statistik Absen </p>
              <h4 class="block antialiased tracking-normal font-sans text-2xl font-semibold leading-snug text-blue-gray-900">
                <?= $totalAbsensi[0]['total'] ?>0%
            ...
            <div class="border-t border-blue-gray-50 p-4">
              <p class="block antialiased font-sans text-base leading-relaxed font-normal text-blue-gray-600">
                <strong class="text-red-500">-5%</strong>&nbsp;MENURUN
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="relative overflow-x-auto my-34">
          <h1 class="text-5xl text-blue-600 font-bold text-start mb-12 "><span class="bg-gradient-to-r from-blue-400 via-blue-700 to-blue-900 text-transparent bg-clip-text drop-shadow-md ">Data Absensi Karyawan, <?php echo $_SESSION['name'] ?> </span>👨‍💻</h1>
              ...
              <tbody>
                ...
                foreach ($karyawan as $karyawan) : ?>
                  <tr class=" border-b bg-[#151c2b] dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                    ...
                    <td class="px-18F py-4">
                      <a href="#" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
                      <a href="hapus.php?id_karyawan=<?= $karyawan['id_karyawan'] ?>" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Hapus</a>
                    </td>
                  </tr>
